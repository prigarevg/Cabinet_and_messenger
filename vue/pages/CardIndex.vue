<template>
    <div class="wrapper">
        <div class="page cardIndex">
            <page-header :title="'Дело «' + (card ? card.name : '') + '»'">
            </page-header>

            <div class="tabs">
                <div class="tab__links">
                    <span class="tab__link active">События</span>
<!--                    <span class="tab__link">Файлы</span>-->
<!--                    <span class="tab__link">Диалог</span>-->
                </div>

                <div class="tab__contents">
                    <div class="tab__content active">
                        <cards-calendar :card="card"/>
                    </div>
...
<script>
import CardFiles from "../components/cardIndexes/CardFiles.vue";
import CardMessenger from "../components/cardIndexes/CardMessenger.vue";
...
import CardModal from "../components/cardIndexes/CardModal";
...
export default {
    ...
    watch: {
        card: function () {
            this.$store.dispatch("setTasks", this.card.card_index_tasks);
        },
    },
    components: {
        PageHeader,
    ...
    mounted() {
        ...
        this.$store.dispatch("setCard", document.location.pathname.match(/[0-9]+/));
    },
    methods: {
        showModal(type, card) {
